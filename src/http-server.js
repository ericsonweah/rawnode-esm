(async function main() {
  ...
  let mimeTypes;
  try {
  import createStaticMiddleware from "../middleware/static-middleware/index.js";
  } catch (_) {}
  try {
  import OptimizedStaticFileServer from "../non-html-static-file-server/index.js";
  } catch (_) {}
  try {
          ...
          try {
              ...
              for (const entry of entries) {
                  ...
                  if (entry.isDirectory()) {
                      ...
                      const plugin =  /* TODO dynamic require → await import(entryPath.js) */ /* TODO dynamic require → await import(entryPath.js) */ /* TODO dynamic require → await import(entryPath.js) */ require(entryPath);
                      // --- End Require ---
