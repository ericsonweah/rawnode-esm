...
// src/submodules/request/index.js

// Node.js Core Modules
const http = require("node:http");
const net = require("node:net");
const url = require("node:url"); // Using node: prefix for consistency
const { URL } = require("node:url"); // Explicit import for URL class
const querystring = require("node:querystring"); // Using node: prefix
const { StringDecoder } = require("node:string_decoder"); // Using node: prefix
const crypto = require("node:crypto"); // Using node: prefix
const zlib = require("node:zlib"); // Using node: prefix
...
module.exports = (request, response, socket, ctx = {}) => {
