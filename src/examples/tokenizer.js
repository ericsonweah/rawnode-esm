...
// ---------------------------------------------------------------------------            // ADDED// moved import for { StringDecoder }
...
// ---------------------------------------------------------------------------            // ADDED
export const scanSync = scanSync; // ADDED
export const scan = scanSync; // alias                                            // ADDED
export const scanAsync = scanAsync; // ADDED
export const fromReadable = fromReadable; // ADDED
...
export const codeFrame = codeFrame; // ADDED
...
export const create = createTokenizer; // ADDED

// expose TOKEN alongside the function export                                              // ADDED
export const TOKEN = TOKEN; // ADDED
