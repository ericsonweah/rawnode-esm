...
import * as __tmp_fsp from "node:fs";
...
// --- 1. Core Node.js Modules ---// moved import for crypto// moved import for fsconst fsp = __tmp_fsp.promises;// moved import for path// moved import for http// moved import for net// moved import for zlib
//// moved import for { Buffer }// moved import for { Transform, pipeline, Readable, Writable }// moved import for { promisify }// moved import for { once }// moved import for os // Only if loadavg is used (recommend removing from helpers)// moved import for querystring // Or use 'qs' if preferred// moved import for { URL }// moved import for { StringDecoder }
...
// --- Requires Buffer at TOP ---// moved import for { Buffer }
 ...
 */
export default (response, request, socket) => {
    ...
    try {
ContentTypeMod = await import("../ContentType/index.js");
    } catch (_) {
        /* optional */
    }
