...
// const { promises: fs } = require("fs");// moved import for fs
const fsp = fs.promises;
// moved import for { join, extname, normalize, sep }// moved import for path// moved import for { createHash, randomUUID }// moved import for http
let http2;
try {
...
// SSE pre-wire: uses NDJSONWriter helpers from NDJSONParser (adjust path as needed)// moved import for NDJSONParser
...
//const TrieNode = require("../trie-node");// moved import for RadixRouter
// moved import for RateLimiter
// moved import for ContentType
// moved import for responseDecorator// moved import for requestDecorator
